...
#  Fecha: 03/06/2025
#  Descripción: Script para analizar y visualizar la efectividad de respuestas de GPT-4 según el tipo de texto evaluado. 
#  Lee los resultados desde un archivo Excel, calcula el porcentaje de respuestas correctas por cada tipo de texto, y 
#  genera una gráfica de barras ordenada que muestra la efectividad alcanzada en cada categoría. La gráfica se guarda en
#  alta calidad para su uso en informes o presentaciones.
# ==========================================================
...
# Leer el archivo de resultados de GPT-4
file_resultados = "resultados_gpt4.xlsx"
...
# Ordenar los tipos de texto por efectividad descendente
...
# Títulos y etiquetas
plt.title("Efectividad por Tipo de Texto (GPT-4)", fontsize=18, fontweight='bold')
...
plt.savefig("efectividad_gpt4_por_tipo_texto.png", dpi=400, bbox_inches='tight')
plt.show()
